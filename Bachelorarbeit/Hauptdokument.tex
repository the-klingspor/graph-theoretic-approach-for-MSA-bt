...
\hyphenation{Nee-dle-man}
\hyphenation{Se-quenz-a-lign-ment}
\hyphenation{Align-ment}
\hyphenation{Se-quenz-a-lign-ments}
\hyphenation{Align-ments}
\hyphenation{Haupt-an-wen-dungs-ge-bie-te}
\hyphenation{Stan-dard-an-satz}
\hyphenation{Ami-no-säu-ren}
...
\include{chapter/anhang_BLOSUM}

\include{chapter/anhang_beispiel_paarweis}
