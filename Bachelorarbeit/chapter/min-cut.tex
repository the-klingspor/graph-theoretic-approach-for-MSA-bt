...
Wie man sieht, sind die Zusammenhangskomponenten unseres \emph{Inzidenzgraphen} genau die Äquivalenzklassen der durch $\mathcal{F}$ induzierten Kanten. 
...
\subsection{Aufbau des Sukzessorgraphen}

Wie wir gesehen haben, ist die Menge an Zuweisungen nach dem \textrm{ResolveAmbiguities}-Aufruf noch nicht \emph{konsistent}
