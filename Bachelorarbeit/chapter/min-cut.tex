...
\begin{center}
	...
	\end{tikzpicture}
\end{center}
\caption{Der auf Sequenz eingeschränkt und um die transitive Hülle erweiterte DAG $G_{S_1}$.}\label{bsp:dag_s1}
\end{figure}
...
\subsubsection{Laufzeit für die Berechnung eines längsten Pfads}
