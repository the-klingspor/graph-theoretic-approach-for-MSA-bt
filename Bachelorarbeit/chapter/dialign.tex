...
\begin{lemma}
	...
	(1) Es exisitert kein Pfad zwischen $u$ und $v$, das heißt $(u,v),(v,u) \notin E^{*}$,
...
\begin{beweis}
	...
	\bewhin Es gelte $u \rightleftharpoons^{*} v$ für $G$. Dann sind die \emph{Anker} von $G'$ die selben wie von $G$, denn $u$ und $v$ haben bereits zuvor \emph{koninzidiert}. Also ist auch $G'$ \emph{regulär}, da $G$ es war.
\end{beweis}\
