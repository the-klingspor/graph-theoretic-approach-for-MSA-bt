...
Um zu verdeutlichen, dass durch doppelte Kanten verbundene Knoten im Sinne unseres \emph{Alignments} äquivalent sind, wurde diese Verbindung mit Äquivalenzpfeilen dargestellt.

\begin{tabular}{r|c|c|c|c|c}
	Bezeichner 	& $[(2,1)]_{\mathcal{A}}$ & $[(2,2)]_{\mathcal{A}}$ & $[(2,3)]_{\mathcal{A}}$ & $[(2,4)]_{\mathcal{A}}$ & $[(2,5)]_{\mathcal{A}}$\\
	Äqu.klasse  & $\{(2,1),(4,2)\}$	      & $\{(2,2),(4,3)\}$       & $\{(2,3),(4,4)\}$       & $\{(2,4),(4,5)\}$       & $\{(2,4),(4,5)\}$ \\
	\hline
	\hline
	            & $[(2,6)]_{\mathcal{A}}$ & $[(2,7)]_{\mathcal{A}}$ & $[(2,8)]_{\mathcal{A}}$ & & \\
	            & $\{(2,6),(4,7)\}$       & $\{(2,7),(4,8)\}$       & $\{(2,8),(4,9)\}$       & & 
